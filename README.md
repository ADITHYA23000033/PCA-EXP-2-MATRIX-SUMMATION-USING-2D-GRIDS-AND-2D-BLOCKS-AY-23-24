...
## OUTPUT:
### FLOAT
<img width="777" height="156" alt="image" src="https://github.com/user-attachments/assets/eae8b7fd-b5c9-4357-bea0-2cc350b63c73" />

### INT 
<img width="722" height="143" alt="image" src="https://github.com/user-attachments/assets/b567311f-814a-4b6f-8e98-38d19beb5a62" />


## RESULT:
The host took 0.892638 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.013782 seconds. Float takes less time to execute than Integer . Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
